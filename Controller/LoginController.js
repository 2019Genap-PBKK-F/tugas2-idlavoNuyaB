...
var routes = function(){
  router.route('/').get(function(req,res){
    var query = 'Select id, email as username, email as password, id_induk_satker,nama from SatuanKerja';
  ...
  router.route('/').post(function(req,res){
    ...
    var query = "Select id, email as username, email as password, id_induk_satker, nama from SatuanKerja where email = @username";
